...
with st.container(key=f"scale_box_{st.session_state.step}"):
    ...
    if st.session_state.step == 0:
        ...
        if st.session_state.step == 1:
            ...
            # Весь текст — в одном HTML-блоке, без переносов строк внутри тегов
            st.markdown(
                '<div style="font-size: 21px !important; font-weight: 500; color: #333333; line-height: 1.7; text-align: justify;">'
                'У СРСР існувала Всесоюзна піонерська організація імені В. І. Леніна — дитяча організація для школярів приблизно від 9 до 14 років.'
                '<br><br>'
                'Піонери об’єднувалися у загони, зазвичай за класами. Вони брали участь у походах, змаганнях, концертах, роботі гуртків і громадських заходах. Часто це були організовані школою або місцевими установами активності, у яких школярі мали брати участь.'
                '<br><br>'
                'Організація мала власну символіку та ритуали: червоний галстук, урочисті лінійки, салют і церемонію вступу з піонерською присягою. Для багатьох дітей це було обов’язковою частиною шкільного життя, а не особистим вибором.'
                '<br><br>'
                'Піонерство було частиною радянської системи виховання. Через організацію дітям прищеплювали офіційні радянські цінності, знайомили їх із державною символікою та героями й залучали до ідеологічних заходів.'
                '</div>',
                unsafe_allow_html=True
            )
