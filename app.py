...
# Шаг 10: Завершающий слайд (все по центру, ваша картинка через прямую вставку)
elif st.session_state.step == 10:
    st.markdown(
        """
        <div style="text-align: center;">
            <div style="font-size: 36px; font-weight: 700; color: #111111; margin-bottom: 25px;">Дякуємо за увагу!</div>
            <div style="margin: 20px auto;">
                <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=400&auto=format&fit=crop" width="220" style="display: block; margin: 0 auto; border-radius: 10px;"/>
            </div>
