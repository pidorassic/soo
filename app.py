...
st.markdown("""
<style>
html, body, [data-testid="stAppViewContainer"] { overflow-x: hidden !important; height: 100vh !important; background-color: #000000 !important; }
.stApp { background-color: #000000 !important; color: #ffffff; text-align: left !important; }
div.block-container { background-color: transparent !important; max-width: 100% !important; width: 100% !important; margin: 0 auto !important; padding: 5rem 3rem 2rem 3rem !important; }
.progress-bar-fixed { position: fixed; top: 0; left: 0; width: 100%; height: 5px; background: rgba(255,255,255,0.15); z-index: 999999; }
.progress-bar-fill { height: 100%; background: linear-gradient(90deg, #d4af6a 0%, #e8c88a 50%, #d4af6a 100%); box-shadow: 0 0 12px rgba(212, 175, 106, 0.8); transition: width 0.5s cubic-bezier(0.16, 1, 0.3, 1); border-radius: 0 3px 3px 0; }
@keyframes slideUpFade { 0% { opacity: 0; transform: translateY(30px); } 100% { opacity: 1; transform: translateY(0); } }
.element-container, .stMarkdown, .stRadio, .stImage, .stButton { animation: slideUpFade 0.8s cubic-bezier(0.16, 1, 0.3, 1) forwards; }
.no-anim, .no-anim * { animation: none !important; transform: none !important; filter: none !important; }
.slide-title { font-size: 28px !important; font-weight: 700 !important; color: #ffffff !important; margin-bottom: 6px !important; line-height: 1.2 !important; text-align: left !important; }
.question-card { background-color: #3a3a3a; border-left: 6px solid #d4af6a; padding: 15px 20px; border-radius: 6px; margin-bottom: 15px; font-size: 18px !important; font-weight: 500 !important; color: #ffffff !important; line-height: 1.6 !important; }
p, label, span, .stMarkdown { font-size: 18px !important; font-weight: 500 !important; line-height: 1.5 !important; text-align: left !important; color: #ffffff !important; }
.stButton > button { background-color: #3a3a3a !important; color: #ffffff !important; font-size: 15px !important; font-weight: 600 !important; border: 1px solid #555555 !important; border-radius: 6px !important; padding: 0.4rem 1.2rem !important; transition: all 0.3s; }
.stButton > button:hover { background-color: #505050 !important; color: #ffffff !important; border-color: #d4af6a !important; transform: translateY(-2px); }
.lesson-card { background-color: #3a3a3a; border-left: 6px solid #d4af6a; padding: 18px 20px; border-radius: 8px; width: 100% !important; min-height: 160px !important; display: block; }
.lesson-card .lesson-title { font-size: 18px !important; font-weight: 700 !important; color: #ffffff !important; margin: 0 0 10px 0 !important; line-height: 1.3 !important; display: block !important; }
.lesson-card .lesson-text { font-size: 15px !important; font-weight: 500 !important; color: #dddddd !important; line-height: 1.55 !important; margin: 0 !important; display: block !important; }
div[data-testid="stImage"] img { max-height: 58vh !important; width: 100% !important; max-width: 100% !important; object-fit: cover !important; border-radius: 12px !important; margin: 0 auto !important; display: block !important; }
.hero-full { position: relative; width: 100%; min-height: 82vh; border-radius: 20px; overflow: hidden; background-image: url('https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=2000&auto=format&fit=crop'); background-size: cover; background-position: center; box-shadow: 0 30px 80px rgba(0,0,0,0.35); display: flex; align-items: center; justify-content: center; }
.hero-full::before { content: ""; position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: linear-gradient(135deg, rgba(10,10,15,0.92) 0%, rgba(20,20,30,0.78) 40%, rgba(30,25,20,0.75) 70%, rgba(10,10,15,0.9) 100%); z-index: 1; }
.hero-content { position: relative; z-index: 2; width: 100%; padding: 40px 50px; display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 82vh; box-sizing: border-box; }
.hero-title { font-size: 54px !important; font-weight: 900 !important; color: #ffffff !important; letter-spacing: 4px !important; line-height: 1.05 !important; margin: 0 0 8px 0 !important; text-align: center !important; text-shadow: 0 4px 30px rgba(0,0,0,0.6); }
.hero-subtitle { font-size: 15px !important; font-weight: 400 !important; color: #d4c5a0 !important; letter-spacing: 6px !important; text-transform: uppercase !important; margin: 0 0 30px 0 !important; text-align: center !important; }
.hero-cards { display: grid; grid-template-columns: repeat(3, 1fr); gap: 14px; max-width: 1050px; width: 100%; margin-bottom: 14px; }
.hero-cards-bottom { display: grid; grid-template-columns: repeat(3, 1fr); gap: 14px; max-width: 1050px; width: 100%; }
.hero-card-link { display: block; background: rgba(58,58,58,0.85); border: 1px solid rgba(212,197,160,0.42); border-radius: 14px; padding: 16px 18px; text-decoration: none !important; color: inherit !important; transition: all 0.4s; min-height: 130px; box-sizing: border-box; position: relative; overflow: hidden; }
.hero-card-link:hover { background: rgba(90,90,90,0.95); border-color: rgba(212,197,160,0.95); transform: translateY(-6px) scale(1.02); box-shadow: 0 20px 45px rgba(0,0,0,0.55); text-decoration: none !important; }
...
.hero-card-link .hc-title { font-size: 15px !important; font-weight: 800 !important; color: #ffffff !important; margin: 0 0 5px 0 !important; letter-spacing: 0.5px !important; line-height: 1.25 !important; }
.hero-card-link .hc-desc { font-size: 12px !important; font-weight: 400 !important; color: #cccccc !important; line-height: 1.45 !important; margin: 0 !important; }
.hero-footer { position: absolute; bottom: 20px; right: 30px; z-index: 2; font-size: 11px !important; color: #cccccc !important; letter-spacing: 2px !important; }
div[data-testid="stDialog"] > div { background-color: #ffffff !important; border-radius: 14px !important; border-left: 6px solid #d4af6a !important; padding: 10px 16px !important; }
div[data-testid="stDialog"] h2 { color: #111111 !important; font-size: 22px !important; font-weight: 800 !important; }
div[data-testid="stDialog"] p, div[data-testid="stDialog"] span { color: #333333 !important; font-size: 16px !important; font-weight: 500 !important; line-height: 1.6 !important; }
div[data-testid="stDialog"] button[aria-label="Close"] { display: none !important; visibility: hidden !important; }
div[data-testid="stDialog"] .stButton > button { background-color: #ffffff !important; color: #333333 !important; font-size: 15px !important; font-weight: 700 !important; border: 2px solid #333333 !important; border-radius: 6px !important; padding: 0.5rem 1.5rem !important; width: 100% !important; }
div[data-testid="stDialog"] .stButton > button:hover { background-color: #333333 !important; color: #ffffff !important; }
...
st.markdown(f'<div class="progress-bar-fixed"><div class="progress-bar-fill" style="width:{progress_pct}%;"></div></div>', unsafe_allow_html=True)
...
with st.container(key=f"scale_box_{st.session_state.step}"):
    ...
    if st.session_state.step == 0:
        ...
        st.markdown(
            ...
            '<div style="font-size:19px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:22px;">Піонери — це радянська дитяча організація для школярів віком від 9 до 14 років.</div>'
            '<div style="font-size:19px;font-weight:600;color:#fff;margin-bottom:8px;">🎒 Чим вони займалися</div>'
            '<div style="font-size:19px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:22px;">Піонери об’єднувалися в загони за класами. Ходили в походи, брали участь у змаганнях і концертах, відвідували гуртки.</div>'
            '<div style="font-size:19px;font-weight:600;color:#fff;margin-bottom:8px;">🔴 Символіка та ритуали</div>'
            '<div style="font-size:19px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:22px;">Червоний галстук, урочисті лінійки та салют. Присяга на церемонії вступу.</div>'
            '<div style="font-size:19px;font-weight:600;color:#fff;margin-bottom:8px;">📖 Мета організації</div>'
            '<div style="font-size:19px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:22px;">Піонерство було частиною радянської системи виховання.</div>',
            unsafe_allow_html=True
        )
        st.write("")
        ...
        st.markdown(
            ...
            '<div style="font-size:18px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:20px;">У 60-х роках ранок школяра починався о 7-й годині. Спочатку — ранкова гігієна, потім — обов’язкова зарядка під радіо.</div>',
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            '<div style="font-size:20px;font-weight:700;color:#fff;margin-bottom:8px;">🔔 08:00. Уроки почалися</div>'
            '<div style="font-size:16px;font-weight:500;color:#ddd;line-height:1.5;margin-bottom:15px;">Попереду — уроки, перерви, відповіді біля дошки й останній дзвоник.</div>',
            unsafe_allow_html=True
        )
        cl, cr = st.columns([1, 1], gap="large")
        with cl:
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:700;color:#fff;margin-bottom:12px;">🍽 14:00. Обід та позаурочні справи</div>'
            '<div style="font-size:18px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:20px;">Після занять школярі поверталися додому на обід. Потім — короткий відпочинок, і знову до справ.</div>',
            unsafe_allow_html=True
        )
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:700;color:#fff;margin-bottom:12px;">🌙 19:00. Домашні завдання та відпочинок</div>'
            '<div style="font-size:18px;font-weight:500;color:#ddd;line-height:1.6;margin-bottom:20px;">Увечері — час на домашнє завдання. Потім читання книжок або настільні ігри з родиною.</div>',
            unsafe_allow_html=True
        )
        cl, cr = st.columns([1, 1], gap="large")
        with cl:
            ...
            st.markdown(
                '<div class="no-anim lesson-card" style="min-height:auto;">'
                '<div class="lesson-title">📚 Читання та ігри</div>'
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:800;color:#fff;margin-bottom:22px;">ПІОНЕРИ ТА СУЧАСНА МОЛОДЬ</div>'
            '<div style="font-size:18px;font-weight:500;color:#ddd;line-height:1.7;margin-bottom:20px;">Піонери 60-х та сучасна молодь жили в різних світах. Одні виховувались у колективі, де головним було спільне благо та дисципліна.</div>'
            '<div style="font-size:18px;font-weight:500;color:#ddd;line-height:1.7;">Інші — у світі, де цінується свобода вибору. Давайте порівняємо.</div>',
            unsafe_allow_html=True
        )
        st.write("")
        c1, c2, _ = st.columns([1, 1, 4])
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:800;color:#fff;margin-bottom:18px;">🌅 РАНОК ПІОНЕРА</div>'
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:800;color:#fff;margin-bottom:18px;">📚 У ШКОЛІ</div>'
            '<div class="question-card">'
        ...
        st.markdown(
            '<div style="font-size:22px;font-weight:800;color:#fff;margin-bottom:18px;">🎒 ПІСЛЯ УРОКІВ</div>'
            '<div class="question-card">'
