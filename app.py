...
# Шаг 10: Завершающий слайд
    ...
    st.markdown('<div style="text-align: center; font-size: 26px; font-weight: 600; margin-top: 40px; color: #111111;">Презентацію підготували учні та учениці 10 «А» класу</div>', unsafe_allow_html=True)
    st.write("")
...
# Кнопка переключения шагов (теперь называется "Далі")
st.write("")
if st.button("Далі"):
    ...
    st.rerun()
```Ось варіанти оформлення завершальних слайдів для вашої презентації. Замість звичного «Слід» кнопка навігації змінена на **«Далі»** (або **«Наступна»**), а фінальний слайд містить потрібну вам формулювання.

**Навігаційна кнопка**
* Текст на кнопці: **Далі** (або **Наступна**)

---

**Завершальний слайд (Варіант 1 — Стандартний)**

Дякуємо за увагу!
Презентацію підготували учениці 10-А класу 
[Імена прізвища або кількість]

---

**Завершальний слайד (Варіант 2 — Універсальний для змішаного класу)**

Кінець
Презентація від учениць та учнів 10-А класу 
[Імена прізвища]

---

**Завершальний слайд (Варіант 3 — Короткий)**

Дякуємо за перегляд!
Презентація від учениць 10-А класу 
[Імена прізвища]
